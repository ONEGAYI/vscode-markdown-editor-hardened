...
export function fixLinkClick() {
  ...
  document.addEventListener('click', (e) => {
    ...
    // Prefer the raw href attribute over link.href: the browser resolves the latter
    // against the webview's internal origin, mangling relative markdown links into
    // unusable absolute vscode-webview:// URLs.
